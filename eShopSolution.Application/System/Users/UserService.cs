...
namespace eShopSolution.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResult<string>> Authenticate(LoginRequest request)
        {
            ...
            if (user == null) return new ApiErrorResult<string>("Tài khoản không tồn tại, vui lòng thử lại");
        ...
        public async Task<ApiResult<PagedResultDto<UserVm>>> GetUsersPaging(GetUserPagingRequest request)
        {
            ...
            var pagedResult = new PagedResultDto<UserVm>()
            {
            ...
            return new ApiSuccessResult<PagedResultDto<UserVm>>(pagedResult);
        }
